...
from diplom_code import AdditionalFitering

# load image
img = cv2.imread('sahrp_0.bmp')
...
cv2.imshow('original_filr', AdditionalFitering.get_final_picture(img))
cv2.imshow('result', result)
cv2.imshow('result_filr', AdditionalFitering.get_final_picture(result))
